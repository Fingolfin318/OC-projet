...
Il y a évidemment la page qui affiche les offres d'emploi ou l'utilisateur (chercheur d'emploi ou étudiant) peut postuler.
...
SPÉCIFICITÉ :
Notre site affiche un message de bienvenue, contenant son nom, à l'utlisateur connecté.
Il se diférencie en fonction qu'on soit un employeur ou un chercheur d'emploi/étudiant.
On peut postuler à des offres que le patron/employeur a poster.
